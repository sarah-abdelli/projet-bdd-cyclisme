...
CREATE TABLE IF NOT EXISTS G10_Coureur (
    coureur_id INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS G10_Edition (
    edition_id INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
-- Insertion des données dans la table G10_Coureur
 ...
 INSERT INTO G10_Coureur (coureur_nom ,coureur_prenom ,nationalite ,nom_equipe ,
    date_naissance )
 VALUES
...
-- 2024
(1, 3317.5, 8400, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Pogacar'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2024-05-04')),
(2, 3316, 8500, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Martinez'), (SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2024-05-04')),
(3, 3315.6, 8600, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Thomas'), (SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2024-05-04')),
    
-- 2023
(1, 3357.8, 8480, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Roglic'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2023-05-06')),
(2, 3357, 8500, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Thomas'), (SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2023-05-06')),
(3, 3356, 8600, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Almeida'), (SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2023-05-06')),
 
 -- 2022
(1, 3499.6, 8550, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Hindley'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2022-05-06')),
(2, 3497, 8580, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Carapaz'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2022-05-06')),
(3, 3495.5, 8600, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Landa'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2022-05-06')),


-- 2021
(1, 3410.9, 8600, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Bernal'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2021-05-08')),
(2, 3410.1, 8610, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Caruso'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2021-05-08')),
(3, 3409, 8620, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Yates' AND coureur_prenom='Simon'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2021-05-08')),
    
-- 2020
(1, 3497.9, 8580, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Geoghegan Hart'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2020-10-03')),
(2, 3497.4, 8600, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Hindley'), (SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2020-10-03')),
(3, 3497.1, 8630, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Kelderman'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2020-10-03')),

-- 2019
(1, 3486.5, 8500, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Carapaz'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2019-05-11')),
(2, 3486.3, 8510, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Nibali'), (SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2019-05-11')),
(3, 3486, 8530, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Roglic'),(SELECT edition_id FROM G10_Edition WHERE course_id = 2 AND edi_dateDebut = '2019-05-11')),
...
-- 2024
(1, 3304, 8450, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Roglic'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2024-08-17')),
(2, 3303.8, 8465, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'O''Connor'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2024-08-17')),
(3, 3303.1, 8490, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Mas'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2024-08-17')),
...
-- 2022
(1, 3283, 8505, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Evenepoel'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2022-08-19')),
(2, 3283, 8525, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Mas'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2022-08-19')),
(3, 3283, 8540, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Ayuso'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2022-08-19')),


-- 2021
(1, 3417, 8500, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Roglic'), (SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2021-08-14')),
(2, 3417, 8520, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Mas'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2021-08-14')),
(3, 3417, 8540, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Haig'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2021-08-14')),

-- 2020
(1, 2846.9, 6980, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Roglic'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2020-10-20')),
(2, 2846.8, 6991, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Carapaz'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2020-10-20')),
(3, 2846.6, 7002, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Carthy'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2020-10-20')),

-- 2019
(1, 3272.2, 8440, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Roglic'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2019-08-24')),
(2, 3272.1, 8450, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Valverde'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2019-08-24')),
(3, 3272, 8470, (SELECT coureur_id FROM G10_Coureur WHERE coureur_nom = 'Pogacar'),(SELECT edition_id FROM G10_Edition WHERE course_id = 3 AND edi_dateDebut = '2019-08-24')),
